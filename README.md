...
2. Copy the repository URL [https://github.com/telescopelabs/sdk-unity.git](https://github.com/telescopelabs/sdk-unity.git) to the input box and click _Add_.    
...
>![](https://raw.githubusercontent.com/Mqxx/GitHub-Markdown/main/blockquotes/badge/warning.svg)
...
>![](https://raw.githubusercontent.com/Mqxx/GitHub-Markdown/main/blockquotes/badge/info.svg)
...
- `value` is a dictionary containing key-value pairs of the data that you want to track. The keys are strings and the values can be of any type that can be cast to object.

This method creates an instance of the *TelescopeGenericTrack* class and populate it with the provided *entityName* (event name) and *value* and then call the Track method to send the event to the server.
...
```
>![](https://raw.githubusercontent.com/Mqxx/GitHub-Markdown/main/blockquotes/badge/warning.svg)
> Don't forget to do mapping in *Data Settings* after you send an event for the first time. You can use preset events if you don't want to do the mapping.
